...
<div class="relative w-full max-w-[1440px] mx-auto min-h-[75vh] sm:min-h-[85vh] max-h-[900px] pb-8 sm:pb-24">
			...
			<div class="grid grid-cols-1 lg:grid-cols-1 gap-8 items-start mx-auto">
				<div class="px-4 lg:px-16 pb-10 sm:pb-24 rounded-3xl min-h-0 sm:min-h-[680px] mx-auto pt-6 sm:pt-20 w-full">
					...
					{#if shouldShowBadge}
						<GuestReportBadge />
					{/if}
					<h1 class="sm:pt-16 pt-4 text-4xl sm:text-5xl font-normal w-[100%] pb-4 sm:pb-8 leading-tight tracking-tight mx-auto text-center font-aeonik">
						What's your
						<span style="min-width: 140px;">
							<span class="single-sweep" data-text="JobPostScore">JobPost<b>Score</b>?</span>
						</span>
					</h1>
					<p class="hidden sm:block sm:text-sm text-gray-400 text-center mb-8 max-w-3xl mx-auto font-normal font-aeonik">
