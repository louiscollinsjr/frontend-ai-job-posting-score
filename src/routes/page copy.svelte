...
<div class="relative w-full h-[85vh] overflow-hidden">
  <div class="absolute inset-0 bg-[url('/bkg2.png')] bg-no-repeat bg-cover bg-center blur-lg opacity-90"></div>
  <!-- <div class="absolute inset-0 bg-gradient-to-b from-white/0 via-white/5 to-white/80"></div>
   -->
    <!-- Hero Section with Audit Form -->
    <section class="mb-4 sm:mb-8 cbg-[radial-gradient(ellipse_at_center,white_0%,transparent_70%)] p-2 min-h-[400px] sm:h-[85vh] relative">
      <div class="container mx-auto sm:pt-16">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-1 gap-8 items-center mx-auto">
          <div class="px-4 lg:px-16 pb-8 sm:pb-20 rounded-3xl min-h-[350px] sm:min-h-[680px] mx-auto pt-8 sm:pt-24">
            ...
            <h1 class="sm:pt-16 pt-16 text-4xl sm:text-7xl font-normal w-[100%] pb-12 leading-tight tracking-tight mx-auto text-center font-aeonik ">
